...
const Icons = {
  ...
  resume: (props: IconProps) => (
    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <path
        fill="currentColor"
        d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8l-6-6zM6 20V4h7v5h5v11H6zM8 12h8v1H8v-1zm0 2h8v1H8v-1zm0 2h8v1H8v-1z"
      />
    </svg>
  ),
};
