...
type UniformEntry = { value: UniformValue; type: string };
...
const ShaderMaterial = ({
  ...
  useFrame(({ clock }) => {
    ...
    const material = ref.current.material as unknown as { uniforms: Record<string, { value: number }> };
  ...
  const getUniforms = () => {
    ...
    for (const uniformName in uniforms) {
      const uniform: UniformEntry = uniforms[uniformName];
