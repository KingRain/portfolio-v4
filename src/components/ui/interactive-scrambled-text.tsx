...
import { useEffect, useRef, FC, ReactNode, CSSProperties } from "react";
...
const InteractiveScrambledText: FC<InteractiveScrambledTextProps> = ({
  ...
  return (
    <div
      ref={rootRef}
      className={`font-mono text-[clamp(12px,1.5vw,20px)] text-neutral-800 dark:text-neutral-200 transition-colors duration-300 ${className}`}
      style={style}
    >
      <p>{children}</p>
    </div>
